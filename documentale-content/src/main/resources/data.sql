...
INSERT INTO document (ref_number, owner, type, state, location, doc_date, create_date, create_user, update_date, update_user, protocol_id) 
VALUES ('D0002', 'Marco', 'TB', 'received', 'MI', '2024-10-13', '2024-10-13', 'Mario Rossi', '2024-10-13', 'Mario Rossi', 1);

INSERT INTO document (ref_number, owner, type, state, location, doc_date, create_date, create_user, update_date, update_user, protocol_id) 
VALUES ('D0003', 'Marco', 'TA', 'received', 'MI', '2024-10-14', '2024-10-14', 'Luca Verdi', '2024-10-14', 'Mario Rossi', 1);

INSERT INTO document (ref_number, owner, type, state, location, doc_date, create_date, create_user, update_date, update_user, protocol_id) 
VALUES ('D0004', 'Chiara', 'TB', 'received', 'MI', '2024-10-12', '2024-10-12', 'Mario Rossi', '2024-10-12', 'Mario Rossi', 2);

INSERT INTO document (ref_number, owner, type, state, location, doc_date, create_date, create_user, update_date, update_user, protocol_id) 
VALUES ('D0005', 'Giovanni', 'TA', 'verify', 'MI', '2024-10-12', '2024-10-12', 'admin', '2024-10-13', 'Alice Bianchi', 2);
...
INSERT INTO document (ref_number, owner, type, state, location, doc_date, create_date, create_user, update_date, update_user, protocol_id) 
VALUES ('D0009', 'Pietro', 'TA', 'archived', 'MI', '2024-10-13', '2024-10-13', 'Mario Rossi', '2024-10-13', 'Luca Verdi', 2);

INSERT INTO document (ref_number, owner, type, state, location, doc_date, create_date, create_user, update_date, update_user, protocol_id) 
VALUES ('D0010', 'Marco', 'TB', 'archived', 'MI', '2024-10-14', '2024-10-14', 'Alice Bianchi', '2024-10-14', 'Luca Verdi', 2);